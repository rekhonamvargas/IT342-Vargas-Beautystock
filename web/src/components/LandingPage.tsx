  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col">
      ...
      <nav className="flex items-center justify-center py-4 border-b border-cream-200">
        <span className="text-pink text-xs mr-1.5">✦</span>
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20 border-b border-cream-200">
        <h1 className="font-serif text-5xl md:text-6xl font-bold text-dark max-w-4xl leading-[1.03] tracking-[-0.01em]">
          Your Beauty Collection,<br />
          <span className="text-pink">Beautifully</span> <span className="text-[#D8A229]">Organized</span>
        </h1>
      ...
      <section className="max-w-[1080px] mx-auto px-6 py-10">
        <h2 className="text-center font-serif text-[44px] font-bold text-dark mb-8">Everything You Need</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {features.map((f) => (
            <div key={f.title} className="rounded-2xl border border-cream-200 bg-white p-5 text-center min-h-[168px]">
              ...
              <h3 className="font-serif font-bold text-dark text-xl leading-tight mb-2">{f.title}</h3>
